...
export class CreateQubiWithRelation1671698756519 implements MigrationInterface {
    name = 'CreateQubiWithRelation1671698756519'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_7609f5163f0aa51c98fece1f73f" FOREIGN KEY ("qubiId") REFERENCES "qubis"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
